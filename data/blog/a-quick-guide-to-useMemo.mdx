---
title: A quick guide to useMemo
date: '2021-12-31'
...
Ok, now let's imagine we have a parent and child component. The child component receives a `num` prop which it then uses to to calculate the expensive function call `someExpensiveFn()`.
